...
//        //必填:待发送手机号
//        request.setPhoneNumbers("18946254241");
//        //必填:短信签名-可在短信控制台中找到
//        request.setSignName("小小邢");
//        //必填:短信模板-可在短信控制台中找到
//        request.setTemplateCode("SMS_462255359");
//        //可选:模板中的变量替换JSON串,如模板内容为"亲爱的${name},您的验证码为${code}"时,此处的值为
//        request.setTemplateParam("{\"coco\":\"1234\"}");
//
...
//        //必填-号码
//        request.setPhoneNumber("18946254241");
//        //可选-流水号
...
//    }
    public static void main(String[] args) throws ClientException, InterruptedException {
        SmsUtil.sendSms("18946254241","小小邢","SMS_462255359","{\"coco\":\"1234\"}");
    }
}